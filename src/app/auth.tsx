...
const styles = StyleSheet.create({
  ...
  card: { marginTop: 28, padding: 20, borderRadius: 24, backgroundColor: '#FFFFFF', shadowColor: '#312E81', shadowOpacity: 0.08, shadowRadius: 16, shadowOffset: { width: 0, height: 8 }, elevation: 3 },
